...
<body>
    ...
    <div class="botones-idioma">
        <h4>IDIOMA</h4>
        <a href="assets/pagIngles/pickupEnglish.html" class="ingles"><img src="assets/imagenes/usa.png" alt=""></a>
        <a href="pickup.html" class="espanol"><img src="assets/imagenes/españa.png" alt=""></a>
    </div>
    <div class="div-tabla">
        <table>
            <thead>
